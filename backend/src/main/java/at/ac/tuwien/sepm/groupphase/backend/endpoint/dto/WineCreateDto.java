...
/**
 * This DTO contains all information to create a new wine.
 */
public class WineCreateDto {
    ...
    public static final class WineCreateDtoBuilder {
        private String name;
        private String vinyard;
        private String description;
        private String link;
        ...
        public WineCreateDtoBuilder withName(String name) {
            this.name = name;
            return this;
        }

        public WineCreateDtoBuilder withVinyard(String vinyard) {
            this.vinyard = vinyard;
            return this;
        }

        public WineCreateDtoBuilder withDescription(String description) {
            this.description = description;
            return this;
        }

        public WineCreateDtoBuilder withLink(String link) {
            this.link = link;
            return this;
        }

        public WineCreateDtoBuilder withGrape(String grape) {
            this.grape = grape;
            return this;
        }

        public WineCreateDtoBuilder withCategory(WineCategory category) {
            this.category = category;
            return this;
        }

        public WineCreateDtoBuilder withTemperature(Double temperature) {
            this.temperature = temperature;
            return this;
        }

        public WineCreateDtoBuilder withCountry(String country) {
            this.country = country;
            return this;
        }

        /**
         * Builds the WineCreateDto with the specified information.
         *
         * @return Returns a new WineCreateDto
         */
        public WineCreateDto build() {
            WineCreateDto wine = new WineCreateDto();
            wine.name = this.name;
