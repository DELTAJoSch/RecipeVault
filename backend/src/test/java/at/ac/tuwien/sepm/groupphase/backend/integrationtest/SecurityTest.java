...
public class SecurityTest implements WineTestData {
    ...
    private Wine wine = new Wine.WineBuilder()
    ...
    @Test
    @Sql(scripts={"classpath:/sql/WineRepositoryTests.sql"})
    public void givenNoOneLoggedIn_whenPost_then400() throws Exception {
        WineDetailsDto messageInquiryDto = wineMapper.wineToWineDetailsDto(wine);
